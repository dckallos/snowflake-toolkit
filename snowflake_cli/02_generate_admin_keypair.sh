...
#
# Produces:
#   ~/.snowflake/keys/admin_rsa_key.p8     (unencrypted PKCS#8, chmod 600)
#   ~/.snowflake/keys/admin_rsa_key.pub    (PEM public key,   chmod 644)
#
...
PRIVATE_KEY="${KEY_DIR}/admin_rsa_key.p8"
PUBLIC_KEY="${KEY_DIR}/admin_rsa_key.pub"
